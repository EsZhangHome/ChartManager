...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
     ...
     * 是否绘制标签
     */
    private boolean mDrawTags =false;
    /**
     * 绘制标签的北境颜色
     */
    private int mTagBgColor = Color.WHITE;
    /**
     * 绘制 标签的字体颜色
     */
...
//            intensity = 0.05f;
    ...
    public void setDrawTags(boolean mDrawTags) {
        this.mDrawTags = mDrawTags;
    }
    ...
    public void setTagBgColor(int mTagBgColor) {
        this.mTagBgColor = mTagBgColor;
    }
    ...
    public void setTagSize(int mTagSize) {
        this.mTagSize = mTagSize;
    }
